  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p>
          You can install Flux using npm, yarn, or by downloading the standalone installer. Choose the method that works
          best for you.
        </p>
          ...
          <TabsContent value="npm" className="space-y-4">
            ...
            <div className="relative rounded-md bg-muted p-4">
              <pre className="font-mono text-sm">
                <code>npm install -g @flux/cli</code>
              </pre>
              <button
      ...
      <Alert>
        ...
        <AlertDescription>
          If you're using a corporate network or behind a firewall, you might need to configure proxy settings. See the{" "}
      ...
      <div className="space-y-4">
        ...
        <p>
          Alternatively, you can use the same installation method you used initially to update to the latest version.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Tabs defaultValue="npm">
          ...
          <TabsContent value="standalone" className="space-y-4">
            ...
            <h3 className="text-lg font-semibold">Windows</h3>
            <p>
              Uninstall Flux using the Windows Control Panel or Settings app, just like any other Windows application.
            </p>
          </TabsContent>
        </Tabs>
      </div>
