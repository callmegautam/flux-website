  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/docs/installation" className="text-primary hover:underline flex items-center">
                  <ArrowRight className="mr-2 h-4 w-4" />
                  Installation
                </Link>
              </li>
              <li>
                <Link href="/docs/quick-start" className="text-primary hover:underline flex items-center">
                  <ArrowRight className="mr-2 h-4 w-4" />
                  Quick Start
                </Link>
              </li>
              <li>
                <Link href="/docs/configuration" className="text-primary hover:underline flex items-center">
                  <ArrowRight className="mr-2 h-4 w-4" />
                  Configuration
                </Link>
              </li>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/docs/package-management" className="text-primary hover:underline flex items-center">
                  <ArrowRight className="mr-2 h-4 w-4" />
                  Package Management
                </Link>
              </li>
              <li>
                <Link href="/docs/dependency-resolution" className="text-primary hover:underline flex items-center">
                  <ArrowRight className="mr-2 h-4 w-4" />
      ...
      <div className="rounded-lg border p-6">
        ...
        <p className="mt-2 text-muted-foreground">Flux provides a simple and intuitive command-line interface.</p>
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <div className="flex items-start gap-2">
            <Terminal className="h-5 w-5 text-primary shrink-0 mt-0.5" />
            <div>
              <p className="font-medium">flux install</p>
              <p className="text-sm text-muted-foreground">Install all dependencies listed in your package.json</p>
            </div>
          </div>
          <div className="flex items-start gap-2">
            <Terminal className="h-5 w-5 text-primary shrink-0 mt-0.5" />
      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Explore all the commands available in the Flux CLI.</p>
              <Button variant="link" asChild className="px-0">
                <Link href="/docs/commands/install">
                  Learn more <ArrowRight className="ml-1 h-4 w-4" />
                </Link>
